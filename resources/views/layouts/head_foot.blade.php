                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="top-header-content">
                            <a href="#"><i class="icon_phone"></i> <span>(880) 172-051-0330</span></a>
                            <a href="#"><i class="icon_mail"></i> <span>info.deshatarc@gmail.com</span></a>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-md-7">
                        <div class="cta-text mb-50">
                            ...
                            <h6>Contact +88 0172-051-0330 to book directly or for advice</h6>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <!--<!--<a href="#" class="partner-logo"><img src="img/core-img/p4.png" alt=""></a>
                        <!-- Single Partner Logo -->
                    <a href="#" class="partner-logo"><img src="img/core-img/.png" alt=""></a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row align-items-baseline justify-content-between">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-footer-widget mb-80">
                            ...
                            <h4>+88 0172-051-0330</h4>
                            <span>Info.deshatarc@gmail.com</span>
                            <span>DESHA Tower, Upazila Moor <br>Kushtia-Jhenaidah Highway, Kushtia.</span>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-8">
                        ...
                        <div class="copywrite-text">
                            <p>
                                ...
                                </script> All rights reserved by DataPulses.</a>
                                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            </p>
                        </div>
                    </div>
